            ...
            <CajaTexto>
              <BloqueParrafos>
                <Parrafo className="introductorio">
                  ...
                  <b>
                    Punta Cana cobra vida con un espectáculo nocturno vibrante.{" "}
                  </b>{" "}
              ...
              <CajaRazon>
                <CajaEncabezado>
                  <TituloRazon>2. Discotecas de Clase Mundial 🎶💃</TituloRazon>
                </CajaEncabezado>
                ...
                <Parrafo>
                  ...
                  sorprenderá con su espectáculo de luces, acróbatas y música en
                  vivo, mientras que Imagine Cave Club, una discoteca dentro de
                  una cueva natural, te hará vibrar con sus ritmos latinos y
                  electrónicos.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                ...
                <Parrafo>
                  ...
                  azoteas ofrecen vistas impresionantes de la ciudad iluminada.
                  Kan Drinks House y Versus Marina son opciones perfectas para
                  disfrutar de un buen trago mientras la brisa marina te
                  envuelve.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                ...
                <Parrafo>
                  Si te gusta la adrenalina, prueba suerte en los casinos de los
                  resorts más lujosos como Hard Rock Hotel & Casino. Además de
                  los juegos de azar, muchos ofrecen espectáculos en vivo y
                  exclusivas fiestas nocturnas.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                <CajaEncabezado>
                ...
                <WrapConImgSide>
                  ...
                  <WrapParrafo>
                    <Parrafo className="">
                      ...
                      Point o La Santa, donde los locales y turistas se unen en
                      una fiesta llena de energía y sabor dominicano.
                    </Parrafo>{" "}
                    <br />
                    <Parrafo className="">
                      Ya sea que busques una noche de fiesta descontrolada o una
                      velada relajada junto al mar, Punta Cana tiene la
                      combinación perfecta de luces, ritmo y playa. ¿Listo para
                      descubrirla? 🌙🔥
                    </Parrafo>{" "}
                  </WrapParrafo>
                </WrapConImgSide>
