            ...
            <CajaTexto>
              <BloqueParrafos>
                <Parrafo className="introductorio">
                  Punta Cana es un paraíso tropical que va mucho más allá de sus
                  impresionantes playas de arena blanca y aguas turquesa. Si te
                  hospedas en una villa privada, tienes la libertad de explorar
                  y disfrutar experiencias únicas que harán de tu viaje algo
                  inolvidable. Aquí te compartimos algunas actividades
                  imperdibles cerca de tu villa en Punta Cana.
                </Parrafo>
              ...
              <CajaRazon>
                ...
                <Parrafo>
                  ...
                  algunas de las mejores playas del Caribe. Puedes disfrutar de
                  un día de sol, nadar en aguas cristalinas o practicar deportes
                  acuáticos como paddleboarding y snorkel.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                <CajaEncabezado>
                ...
                <Parrafo>
                  Uno de los destinos más populares es la Isla Saona, famosa por
                  sus playas paradisíacas y piscinas naturales. Un paseo en
                  catamarán o lancha rápida te permitirá descubrir este rincón
                  del paraíso con un ambiente relajado y vistas impresionantes.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                <CajaEncabezado>
              ...
              <CajaRazon>
                ...
                <Parrafo>
                  ...
                  aventuras, desde tirolesas y cenotes escondidos hasta cavernas
                  y actividades acuáticas. Perfecto para quienes buscan emoción
              ...
              <CajaRazon>
                ...
                <WrapConImgSide>
                  <CajaImgCuerpo className="size40">
                    <Img src={ImgCenote} className="size100" />
                  </CajaImgCuerpo>
                  <WrapParrafo>
                    <Parrafo className="">
                      El Hoyo Azul es un cenote de agua dulce con un color azul
                      intenso que parece sacado de una postal. Es un lugar
                      increíble para nadar y disfrutar de la belleza natural de
                      Punta Cana.
                    </Parrafo>{" "}
                    <br />
                    <Parrafo className="">
                      ...
                      caliza, creando un paisaje fascinante con aguas de un azul
                      profundo y cristalino que parecen sacadas de un sueño.
                    </Parrafo>{" "}
                  </WrapParrafo>
                </WrapConImgSide>
              </CajaRazon>
              <CajaRazon>
                ...
                <Parrafo>
                  ...
                  restaurantes ofrecen cenas privadas frente al mar. Disfruta de
                  mariscos frescos y una copa de vino mientras el sol se esconde
                  en el horizonte.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                ...
                <Parrafo>
                  ...
                  oportunidad de jugar en campos diseñados por grandes expertos,
                  como Punta Espada o Corales.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                <CajaEncabezado>
                ...
                <Parrafo>
                  Ubicado a una hora de Punta Cana, Altos de Chavón es un pueblo
                  inspirado en la arquitectura mediterránea. Allí encontrarás
                  galerías de arte, tiendas, restaurantes y un impresionante
                  anfiteatro con vista al río Chavón.
                </Parrafo>
              </CajaRazon>
              <CajaRazon>
                <CajaEncabezado>
              ...
              <CajaRazon>
                ...
                <Parrafo>
                  ...
                  flexibilidad de planear tu itinerario y descubrir lo mejor del
                  Caribe a tu ritmo. ¡Prepara tu viaje y vive unas vacaciones
                  inolvidables en Punta Cana! 🌴✨
                </Parrafo>
              </CajaRazon>
