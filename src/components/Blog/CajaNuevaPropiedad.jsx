    ...
    <Container>
      ...
      <CajaInput>
        ...
        <Input
          ...
          onChange={(e) => handleInput(e)}
          type="text"
          placeholder="Subtitulo del propiedad"
          autoComplete="off"
        />
      </CajaInput>
      <CajaInput>
      ...
      <CajaInput>
        ...
        <CajaFotosAreas>
          <CajaInput className="internal">
            <TituloInterno>Area</TituloInterno>
            <MenuDespSimple></MenuDespSimple>
            <WrapSubInternal>
              <CajaInput className="subInternal">
                <Input
            ...
            <CajaBtnInternal>
              <BtnSimple className="small">+</BtnSimple>
              <BtnSimple className="small">-</BtnSimple>
              <BtnSimple className="small">Comp.</BtnSimple>
            </CajaBtnInternal>
          </CajaInput>
          <CajaInput className="internal">
            <TituloInterno>Area</TituloInterno>
...
const CajaFotosAreas = styled.div`
...
const WrapSubInternal = styled.div`
  ...
  overflow-y: scroll;
  height: 200px;
  border: 2px solid ${theme.secondary.coral};
`;
